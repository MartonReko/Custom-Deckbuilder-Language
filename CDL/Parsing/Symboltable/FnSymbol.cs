...
namespace CDL.Parsing.Symboltable;
...
public class FnSymbol : Symbol
{
    ...
    private readonly ILogger<FnSymbol> _logger = LoggerFactory.Create(builder => builder.AddNLog().SetMinimumLevel(Microsoft.Extensions.Logging.LogLevel.Trace)).CreateLogger<FnSymbol>();
